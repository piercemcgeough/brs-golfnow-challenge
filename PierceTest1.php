...
class Member extends Player implements PlayerType, ChargeRate
{
    public function getChargeRate(): int 
    {
        return 10;
...
class Visitor extends Player implements PlayerType, ChargeRate
{
    public function getChargeRate(): int
    {
        return 30;
...
class Juvenile extends Player implements PlayerType, ChargeRate
{
    public function getChargeRate(): int
    {
        return 5;
